...
function setAlarm() {
    ...
    if (lunchValue == hours) {
        ...
        document.querySelector('#msg-img').style.background = "url(./Assets/lunch.png)";
    ...
    if (napValue == hours) {
        ...
        document.querySelector('#msg-img').style.background = "url(./Assets/evening1.jpg)";
    ...
    if (nightValue == hours) {
        ...
        document.querySelector('#msg-img').style.background = "url(./Assets/night.png)";
